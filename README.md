...
- **`main`** — protegida. Solo recibe cambios por Pull Request, con al menos una aprobación de otra persona (GitHub no permite auto-aprobar) y el gate de CI en verde. Sin *push* directo ni *force-push*.
